...
public class CLI
{
    private static readonly IngredientsService Service = new IngredientsService();
    ...
    private static void AddMenu()
    {
        ...
        if (Service.AddIngredient(name, quantityValue))
        {
    ...
    private static void EditMenu()
    {
        ...
        var currentIngredients = Service.GetAllIngredients();
        ...
        var ingredientToEdit = Service.GetIngredientById(id);
        ...
        if (Service.EditIngredient(id, newName, newQuantity))
        {
            Console.WriteLine("\nEdit successful!");
            // Show the updated ingredient details.
            var updatedIngredient = Service.GetIngredientById(id);
    ...
    private static void DeleteMenu()
    {
        ...
        Console.WriteLine(Service.DeleteIngredient(id)
